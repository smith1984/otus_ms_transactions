...
application {
    mainClass.set("ru.beeline.order.ApplicationKt")
}
...
dependencies {
    ...
    implementation(project(":svc_delivery"))
    implementation(project(":svc_payment"))
    implementation(project(":svc_warehouse"))
